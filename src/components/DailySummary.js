...
function DailySummary({ meals, date, onMealDeleted }) {
  ...
  <div className="bg-red-100 p-3 sm:p-4 rounded text-center">
    ...
    <p className="text-xl sm:text-2xl font-bold">{Math.round(dailyTotals.protein)}<span className="font-normal">g</span></p>
  </div>
  <div className="bg-yellow-100 p-3 sm:p-4 rounded text-center">
    ...
    <p className="text-xl sm:text-2xl font-bold">{Math.round(dailyTotals.carbs)}<span className="font-normal">g</span></p>
  </div>
  <div className="bg-green-100 p-3 sm:p-4 rounded text-center">
    ...
    <p className="text-xl sm:text-2xl font-bold">{Math.round(dailyTotals.fat)}<span className="font-normal">g</span></p>
  </div>
</div>
          ...
          <div className="space-y-2">
            {meals.map((meal) => (
              <div key={meal.id} className="p-3 bg-gray-50 rounded flex justify-between items-center">
                <div>
